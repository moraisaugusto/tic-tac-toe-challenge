...
-d '{"player_name":"Augusto", "position": 6}' \
http://localhost:5000/api/games/$game_id
sleep 0.1


curl -X POST -H "Content-Type: application/json" \
-d '{"player_name":"Flavio", "position": 1}' \
http://localhost:5000/api/games/$game_id
sleep 0.1
...
curl -X POST -H "Content-Type: application/json" \
-d '{"player_name":"Augusto", "position": 9}' \
http://localhost:5000/api/games/$game_id
sleep 0.1

curl -X POST -H "Content-Type: application/json" \
-d '{"player_name":"Flavio", "position": 3}' \
http://localhost:5000/api/games/$game_id
sleep 0.1

curl -X POST -H "Content-Type: application/json" \
-d '{"player_name":"Augusto", "position": 7}' \
http://localhost:5000/api/games/$game_id


curl -X POST -H "Content-Type: application/json" \
-d '{"player_name":"Flavio", "position": 8}' \
http://localhost:5000/api/games/$game_id
sleep 0.1
